<script>
import '../assets/frontend/autofix_htmlcss/assets/css/style.css';
...
<header class="header">
  <div class="container">
    ...
    <a href="#" class="logo">
      <img src="../assets/frontend/autofix_htmlcss/assets/images/logo.png" width="128" height="63" alt="autofix home">
    </a>
...
<main>
    <article>
      ...
      <section class="hero has-bg-image" aria-label="home" >
        <div class="container">
          ...
          <figure class="hero-banner" style="--width: 1228; --height: 789;">
            <img src="../assets/frontend/autofix_htmlcss/assets/images/hero-banner.png" width="1228" height="789" alt="red motor vehicle"
              class="move-anim">
          </figure>
      ...
      <section id="services" class="section service has-bg-image" aria-labelledby="service-label"
        style="background-image: url('../assets/frontend/autofix_htmlcss/assets/images/service-bg.jpg')">
        <div class="container">
          ...
          <ul class="service-list">
            ...
            <li>
              <div class="service-card">
                ...
                <figure class="card-icon">
                  <img src="../assets/frontend/autofix_htmlcss/assets/images/services-1.png" width="110" height="110" loading="lazy" alt="Engine Repair">
                </figure>
            ...
            <li>
              <div class="service-card">
                ...
                <figure class="card-icon">
                  <img src="../assets/frontend/autofix_htmlcss/assets/images/services-2.png" width="110" height="110" loading="lazy" alt="Brake Repair">
                </figure>
            ...
            <li>
              <div class="service-card">
                ...
                <figure class="card-icon">
                  <img src="../assets/frontend/autofix_htmlcss/assets/images/services-3.png" width="110" height="110" loading="lazy" alt="Tire Repair">
                </figure>
            ...
            <li>
              <div class="service-card">
                ...
                <figure class="card-icon">
                  <img src="../assets/frontend/autofix_htmlcss/assets/images/services-4.png" width="110" height="110" loading="lazy"
                    alt="Battery Repair">
                </figure>
            ...
            <li class="service-banner">
              <img src="../assets/frontend/autofix_htmlcss/assets/images/services-5.png" width="646" height="380" loading="lazy" alt="Red Car"
                class="move-anim">
            </li>
            ...
            <li>
              <div class="service-card">
                ...
                <figure class="card-icon">
                  <img src="../assets/frontend/autofix_htmlcss/assets/images/services-6.png" width="110" height="110" loading="lazy"
                    alt="Steering Repair">
                </figure>
      ...
      <section id="about" class="section about has-before" aria-labelledby="about-label">
        <div class="container">
          ...
          <figure class="about-banner">
            <img src="../assets/frontend/autofix_htmlcss/assets/images/about-banner.png" width="540" height="540" loading="lazy"
          ...
          <ul class="has-scrollbar">
            ...
            <li class="scrollbar-item">
              <div class="work-card">
                ...
                <figure class="card-banner img-holder" style="--width: 350; --height: 406;">
                  <img src="../assets/frontend/autofix_htmlcss/assets/images/work-1.jpg" width="350" height="406" loading="lazy" alt="Engine Repair"
                    class="img-cover">
                </figure>
            ...
            <li class="scrollbar-item">
              <div class="work-card">
                ...
                <figure class="card-banner img-holder" style="--width: 350; --height: 406;">
                  <img src="../assets/frontend/autofix_htmlcss/assets/images/work-2.jpg" width="350" height="406" loading="lazy" alt="Car Tyre change"
                    class="img-cover">
                </figure>
            ...
            <li class="scrollbar-item">
              <div class="work-card">
                ...
                <figure class="card-banner img-holder" style="--width: 350; --height: 406;">
                  <img src="../assets/frontend/autofix_htmlcss/assets/images/work-3.jpg" width="350" height="406" loading="lazy" alt="Battery Adjust"
                    class="img-cover">
                </figure>
...
<div class="footer-top section">
      ...
      <ul class="social-list">
        ...
        <li>
          <a href="#" class="social-link">
            <img src="../assets/frontend/autofix_htmlcss/assets/images/facebook.svg" alt="facebook">
          </a>
        </li>

        <li>
          <a href="#" class="social-link">
            <img src="../assets/frontend/autofix_htmlcss/assets/images/instagram.svg" alt="instagram">
          </a>
        </li>

        <li>
          <a href="#" class="social-link">
            <img src="../assets/frontend/autofix_htmlcss/assets/images/twitter.svg" alt="twitter">
          </a>
        </li>
  ...
  <img src="../assets/frontend/autofix_htmlcss/assets/images/footer-shape-3.png" width="637" height="173" loading="lazy" alt="Shape"
...
<div class="footer-bottom">
  <div class="container">
    ...
    <p class="copyright">Copyright 2022, Autofix.</p>

    <img src="../assets/frontend/autofix_htmlcss/assets/images/footer-shape-2.png" width="778" height="335" loading="lazy" alt="Shape"
      class="shape shape-2">

    <img src="../assets/frontend/autofix_htmlcss/assets/images/footer-shape-1.png" width="805" height="652" loading="lazy" alt="Red Car"
...
.hero.has-bg-image {
  background-image: url('../assets/frontend/autofix_htmlcss/assets/images/hero-bg.jpg');
}
